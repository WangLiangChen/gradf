package liangchen.wang.gradf.component.commons.manager.domain.result;
...
*/
public class ExtendPropertyResultDomain extends ResultDomain {
    private static final ExtendPropertyResultDomain self = new ExtendPropertyResultDomain();

    public static ExtendPropertyResultDomain newInstance() {
