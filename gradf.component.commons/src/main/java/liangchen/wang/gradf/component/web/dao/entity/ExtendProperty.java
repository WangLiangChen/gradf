package liangchen.wang.gradf.component.web.dao.entity;
 ...
 */
@Entity(name = "gradf_extend_property")
public class ExtendProperty extends RootEntity {
    private static final ExtendProperty self = new ExtendProperty();

    public static ExtendProperty newInstance() {
