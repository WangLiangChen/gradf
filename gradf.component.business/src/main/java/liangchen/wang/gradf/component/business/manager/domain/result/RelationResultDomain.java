...
*/
public class RelationResultDomain extends ResultDomain {
    private static final RelationResultDomain self = new RelationResultDomain();

    public static RelationResultDomain newInstance() {
