...
*/
public class GroupRoleResultDomain extends ResultDomain {
    private static final GroupRoleResultDomain self = new GroupRoleResultDomain();

    public static GroupRoleResultDomain newInstance() {
