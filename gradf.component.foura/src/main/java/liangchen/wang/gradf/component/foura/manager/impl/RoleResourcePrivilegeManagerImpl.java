 ...
 */
@Component("Gradf_Foura_DefaultRoleResourcePrivilegeManager")
public class RoleResourcePrivilegeManagerImpl extends AbstractManager<RoleResourcePrivilege, RoleResourcePrivilegeQuery, RoleResourcePrivilegeResultDomain> implements IRoleResourcePrivilegeManager {
    @Inject
    public RoleResourcePrivilegeManagerImpl(@Named("Gradf_Foura_DefaultRoleResourcePrivilegeDao") IRoleResourcePrivilegeDao dao) {
