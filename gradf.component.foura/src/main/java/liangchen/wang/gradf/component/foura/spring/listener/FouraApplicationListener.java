...
public class FouraApplicationListener implements ApplicationListener<ApplicationEvent> {
    ...
    private void onApplicationReady(ApplicationReadyEvent applicationEvent) {
        ...
        IInitializationManager initializer = BeanLoader.INSTANCE.getBean("Gradf_Foura_DefaultInitializationService", IInitializationManager.class);
        // 初始化数据和权限
        initializer.initFouraData();
