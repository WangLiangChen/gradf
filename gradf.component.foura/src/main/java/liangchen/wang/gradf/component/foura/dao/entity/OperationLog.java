 ...
 */
@Entity(name = "gradf_operation_log")
public class OperationLog extends RootEntity {
    private static final OperationLog self = new OperationLog();

    public static OperationLog newInstance() {
