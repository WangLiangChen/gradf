 ...
 */
public class OperationLogResultDomain extends ResultDomain {
    private static final OperationLogResultDomain self = new OperationLogResultDomain();

    public static OperationLogResultDomain newInstance() {
