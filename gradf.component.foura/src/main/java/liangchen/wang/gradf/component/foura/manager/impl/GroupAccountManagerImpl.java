 ...
 */
@Component("Gradf_Foura_DefaultGroupAccountManager")
public class GroupAccountManagerImpl extends AbstractManager<GroupAccount, GroupAccountQuery, GroupAccountResultDomain> implements IGroupAccountManager {
    @Inject
    public GroupAccountManagerImpl(@Named("Gradf_Foura_DefaultGroupAccountDao") IGroupAccountDao dao) {
    ...
    public boolean deleteByPrimaryKey(Long group_id, Long account_id) {
        Assert.INSTANCE.notNull(group_id, "group_id不能为空");
    ...
    public GroupAccountResultDomain byPrimaryKeyOrThrow(Long group_id, Long account_id, String... returnFields) {
        ...
        Assert.INSTANCE.notNull(groupAccountResultDomain, "数据不存在");
