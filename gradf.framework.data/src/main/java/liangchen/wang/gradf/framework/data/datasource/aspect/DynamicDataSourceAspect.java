...
import liangchen.wang.crdf.framework.data.datasource.annotation.SwitchDataSource;
...
public class DynamicDataSourceAspect {
	...
	@After("@annotation(liangchen.wang.crdf.framework.data.datasource.annotation.SwitchDataSource) || @within(liangchen.wang.crdf.framework.data.datasource.annotation.SwitchDataSource)")
