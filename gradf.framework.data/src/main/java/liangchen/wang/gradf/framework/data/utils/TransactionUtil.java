...
import liangchen.wang.crdf.framework.data.transaction.AfterCommitExecutor;
...
public enum TransactionUtil {
    ...
    private final AfterCommitExecutor afterCommitExecutor = BeanLoader.getBean("CrdfAfterCommitExecutor");
