...
import liangchen.wang.gradf.framework.commons.encryption.Base64Util;
...
public enum RSAUtil {
    ...
    public String rsa256(String content, String privateKey, String charset) {
        ...
        try {
            ...
            throw new ErrorException("数据签名失败:{}", e.getLocalizedMessage());
        }
    }
    ...
    public boolean rsa256Verify(String content, String sign, String publicKey, String charset) {
        ...
        try {
            ...
            throw new ErrorException(e, "RSA content = {},sign={},charset = {}", content, sign, charset);
        }
    }
    ...
    private PrivateKey getPrivateKeyFromPKCS8(String algorithm, InputStream inputStream) {
        ...
        byte[] encodedKey = IOStreamUtil.INSTANCE.readString(inputStream).getBytes();
    ...
    private PublicKey getPublicKeyFromX509(String algorithm, InputStream inputStream) {
        ...
        IOStreamUtil.INSTANCE.io(new InputStreamReader(inputStream), writer);
